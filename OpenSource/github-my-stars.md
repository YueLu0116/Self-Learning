...
- [ShellProgressBar-c#](https://github.com/Mpdreamz/shellprogressbar)
- [ShareX-c#](https://github.com/ShareX/ShareX)
...
- [SharpZipLib-c#](https://github.com/icsharpcode/SharpZipLib)
- [mermaid-Generation of diagram and flowchart from text in a similar manner as markdown](https://github.com/mermaid-js/mermaid)
- [recipes-Some code snippets for sharing](https://github.com/chenshuo/recipes)
...
- [FFmpegInterop library for Windows](https://github.com/microsoft/FFmpegInterop)
- [OBS-Studio](https://github.com/obsproject/obs-studio)
- [fanplayer](https://github.com/rockcarry/fanplayer)
- [sonobus-Source code for SonoBus, a real-time network audio streaming collaboration tool.](https://github.com/sonosaurus/sonobus)
...
- [EasyHttp-Http Library for C#](https://github.com/EasyHttp/EasyHttp)
- [Fleck-C# Websocket Implementation](https://github.com/statianzo/Fleck)
- [shadowsocks-windows](https://github.com/shadowsocks/shadowsocks-windows)
- [unpv13e-UNIX Network Programming, Volume 1, Third Edition Source Code](https://github.com/unpbook/unpv13e)
